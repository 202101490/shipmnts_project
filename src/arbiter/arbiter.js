...
import {getBarCher , getWarCher} from './move';
    ...
    getRegularMoves : function ({position,piece,rank,file}) {
        ...
        if (piece.endsWith('b')){
            ...
            if(piece.startsWith('w')){
                if(getWarCher() === 0) return getBishopMoves({position,piece,rank,file});
                else             return getRookMoves({position,piece,rank,file});
            }else{
                if(getBarCher() === 0) return getBishopMoves({position,piece,rank,file});
                else             return getRookMoves({position,piece,rank,file});
            }
